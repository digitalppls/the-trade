    ...
    <div class="grid">
        <div class="col-12">
            <div class="flex flex-column sm:flex-row align-items-center gap-4">
                ...
                <div class="flex gap-2 sm:ml-auto">
                    <Button type="button" :label="$t('myAccounts.trade')" icon="pi pi-arrows-h" class="p-button-rounded p-button-outlined"></Button>
                    <Button type="button" :label="$t('myAccounts.topUp')" icon="pi pi-download" class="p-button-rounded p-button-outlined"></Button>
                    <Button type="button" :label="$t('myAccounts.withdraw')" icon="pi pi-money-bill" class="p-button-rounded"></Button>
                    <Button type="button" v-tooltip.bottom="$t('myAccounts.notifications')" icon="pi pi-bell" class="p-button-rounded"></Button>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 lg:col-6">
            <div class="card">
                ...
                <DataTable ref="dt" :value="payments" dataKey="id" :rows="5" class="datatable-responsive" emptyMessage="No products found." responsiveLayout="scroll">
