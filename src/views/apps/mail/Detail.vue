    ...
    <div>
        <div class="flex flex-column md:flex-row md:align-items-center md:justify-content-between mb-5 pt-5 md:pt-0 gap-4 md:border-top-none border-top-1 surface-border">
            <div class="flex align-items-center md:justify-content-start">
                <Button type="button" icon="pi pi-chevron-left" class="p-button-text p-button-plain md:mr-3" @click="goBack()"></Button>
            ...
            <div class="flex align-items-center justify-content-end column-gap-3 px-4 md:px-0">
                ...
                <Button type="button" icon="pi pi-reply" class="p-button-text p-button-plain flex-shrink-0"></Button>
                <Button type="button" icon="pi pi-ellipsis-v" class="p-button-text p-button-plain flex-shrink-0"></Button>
            </div>
        </div>
