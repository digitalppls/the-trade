    ...
    <div class="p-4">
        <div class="grid p-fluid formgrid">
            ...
            <div class="col-12 field">
                ...
                <Editor v-model="task.description"></Editor>
            </div>
            ...
            <div class="col-12 field">
                ...
                <AutoComplete appendTo="body" inputId="members" v-model="task.members" :suggestions="filteredMembers" field="name" multiple @complete="filterMembers($event)" :inputStyle="{ height: '2.5rem' }">
                    <template #chip="{ value }">
